...
def findEvents(symbols, startday,endday, marketSymbol,verbose=False):
	...
	for symbol in symbols:
	    ...
	    for i in range(2,len(close[symbol])):
	        if close[symbol][i-1] > 5 and close[symbol][i] < 5 : # When the stock drop below 5 for the first time
...
#eventProfiler.study(filename="sp5002008.pdf",plotErrorBars=True,plotMarketNeutral=True,plotEvents=False,marketSymbol='SPY')
